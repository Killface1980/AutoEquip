    ...
    public class ITab_Pawn_GearModded : ITab
    {
        ...
        protected override void FillTab()
        {
            ...
            if (this.SelPawnForGear.equipment != null)
            {
                ...
                {
                    this.DrawThingRow(ref num, viewRect.width, current, pawnSave, pawnCalc);
                }
            }
            if (this.SelPawnForGear.apparel != null)
            {
                ...
                foreach (Apparel current2 in from ap in this.SelPawnForGear.apparel.WornApparel
                                             ...
                                             select ap)
                {
                    this.DrawThingRow(ref num, viewRect.width, current2, pawnSave, pawnCalc);
                }
            }
            if (this.SelPawnForGear.inventory != null)
            {
                ...
                {
                    this.DrawThingRow(ref num, viewRect.width, ITab_Pawn_GearModded.workingInvList[i], pawnSave, pawnCalc);
                }
            }
        ...
        private void DrawThingRow(ref float y, float width, Thing thing, SaveablePawn pawnSave, PawnCalcForApparel pawnCalc)
        {
